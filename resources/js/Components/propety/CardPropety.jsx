...
export default function CardPropety({propety}) {
    return (
        <Card className="w-full max-w-[26rem] shadow-lg border border-gray-200">
            <CardHeader floated={false} color="blue-gray">
                <img
                    src={`/storage/${propety.images[0].path}`}
            ...
            <CardFooter className="pt-3">
                <Link href={`/propeties/${propety.id}`}>
